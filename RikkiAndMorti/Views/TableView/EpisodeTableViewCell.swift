...
//  RikkiAndMorti
//
//  Created by Дмитро Сегейда on 28.07.2023.
//
...
class EpisodeTableViewCell: UITableViewCell {
    ...
    @IBOutlet weak var labelAired: UILabel!
    ...
    func setLabel(with text: String, label: UILabel, font: CGFloat, name: String, bold: Bool) {
